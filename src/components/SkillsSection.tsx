  ...
  return (
    <section id="skills" className="section" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="skills-title-wrapper"><TextPressure text="TECHNICAL SKILLS" flex={true} alpha={false} stroke={false} width={true} weight={true} italic={true} textColor="var(--foreground)" minFontSize={28} /></div>
        <div className="skills-interactive-container"><div className="skills-sphere-column" style={{ width: '100%' }}><TechSphere /></div></div>
      </div>
    </section>
  );
}
